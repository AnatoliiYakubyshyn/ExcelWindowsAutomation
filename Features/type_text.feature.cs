...
namespace WordPadTesting.Features
{
    ...
    public partial class TypeTextFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Type text", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Check text content")]
        [NUnit.Framework.TestCaseAttribute("hello world!", null)]
        [NUnit.Framework.TestCaseAttribute("good bye", null)]
        [NUnit.Framework.TestCaseAttribute("Hello", null)]
        public void CheckTextContent(string text, string[] exampleTags)
        {
